...
# FIXED: quote escaping in cat() statements
################################################################################
...
if ("IGF1R" %in% rownames(all_expr)) {
  ...
  cat("IGF1R sound:", round(s_mean, 4), "| deep caries:", round(d_mean, 4), "\n")
...
cat("------------------------------------------------------------------------\n")
cat("IGF1R + Sox2 co-expression CONFIRMED in mouse incisor and human apical papilla\n")
